...
DECLARE_SETTINGSFACT(FlyViewSettings, vehicleIconSizeScale)
DECLARE_SETTINGSFACT(FlyViewSettings, vehicleIconColor)
DECLARE_SETTINGSFACT(FlyViewSettings, liveTrackingEnabled)
DECLARE_SETTINGSFACT(FlyViewSettings, liveTrackingServerUrl)
DECLARE_SETTINGSFACT(FlyViewSettings, liveTrackingInterval)
